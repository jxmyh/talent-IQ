        ...
        <div className="max-w-7xl mx-auto p-4 flex justify-between  items-center">
          ...
          <Link
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs to-base-content/60 font-medium -mt-1">
                Code Together
              </span>
            </div>
          </Link>
          ...
          <SignInButton mode="modal">
            <button className="group px-6 py-3 bg-gradient-to-r from-primary to-secondary rounded-xl text-white font-semibold text-sm shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 flex items-center gap-2">
              ...
              <ArrowRightIcon className="size-4 group-hover:translate-x-.5"></ArrowRightIcon>
            </button>
          </SignInButton>
        </div>
      </nav>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-xl text-base-content/70 leading-relaxed max-w-xl">
              The ultimate platform for collaborative codeing interviews and
              pair programming.Conect face-to-face, code in real-time, and ace
            ...
            <div className="flex flex-wrap gap-3">
              <div className="badge badge-lg badge-outline">
                <CheckIcon className="size-4 text-success"></CheckIcon>
                Live Video Chat
              </div>
              <div className="badge badge-lg badge-outline">
                <CheckIcon className="size-4 text-success"></CheckIcon>
